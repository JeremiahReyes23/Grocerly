...
function initOnboardingFlow() {
  ...
  document.getElementById("btn-login-google").addEventListener("click", () => handleSocialLogin("Google"));
  document.getElementById("btn-login-apple").addEventListener("click", () => handleSocialLogin("Apple"));
